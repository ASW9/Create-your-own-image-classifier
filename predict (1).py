...
parser.add_argument("--topk", type = int, default = 5, help = """returns the top k classes where k is the your input (e.g 
                     an input of 5 means the top 5 will be given""")
...
parser.add_argument("--gpu", action = "store_true", default = True, help = "toggles gpu inference, default is false")
...
load = load_checkpoint(checkpoint)
load.to(device)

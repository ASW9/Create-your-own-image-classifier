...
parser.add_argument("--architecture", default = "vgg19", help ="neural net architecture either vgg19 or densenet121", pretrained = True)
...
parser.add_argument("--gpu", type = store_type, default = False, help = "CUDA computation enabling, faster training etc.")
...
elif args.in.architecture == 'densenet121':
...
print("architecture type{}".format(args.in.architecture))
